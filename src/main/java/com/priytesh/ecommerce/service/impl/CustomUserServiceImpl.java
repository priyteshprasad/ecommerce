...
import com.priytesh.ecommerce.repository.SellerRepository;
...
public class CustomUserServiceImpl implements UserDetailsService {
    ...
    private static final String SELLER_PREFIX="seller_"; //if the user is seller than check seller table else check user table
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        throw new UsernameNotFoundException("User or seller not found with"+username);
